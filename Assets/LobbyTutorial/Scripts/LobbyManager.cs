...
public class LobbyManager : MonoBehaviour {
    ...
    public async void Authenticate(string playerName) {
        ...
        // Replace spaces with underscores or remove them for Unity Authentication
        string sanitizedPlayerName = playerName.Replace(" ", "_");  // or you can use sanitizedPlayerName = playerName.Replace(" ", "");

        // Now use the sanitized name for authentication
